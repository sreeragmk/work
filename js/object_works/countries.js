...
//let currencies=countries[0].currencies[0].name
let myCountries=[]
...
let cntry_data={countryName:countryName,population:population,capital:capital,currencies:currencies}
                //{countryName,population,capital,currencies}
myCountries.push(cntry_data)
}
//console.log(myCountries);
//myCountries.forEach(data=>console.log(data.countryName))
// myCountries.map(data=>data.countryName).forEach(dd=>console.log(dd))


//print details of india

let ind_data=myCountries.find(d1=>d1.countryName=="India")
// console.log(ind_data);

//currencies of china

let china=myCountries.find(d1=>d1.countryName=="China").currencies
// console.log(china);
myCountries.filter(d1=>d1.population>20000000).map(cntry=>cntry.countryName).forEach(name=>console.log(name));
